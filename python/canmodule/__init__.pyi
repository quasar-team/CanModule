...
__all__ = ['CanDevice', 'CanDeviceArguments', 'CanDeviceConfiguration', 'CanDiagnostics', 'CanFrame', 'CanReturnCode', 'can_flags', 'disconnected', 'internal_api_error', 'invalid_bitrate', 'lost_arbitration', 'not_ack', 'rx_error', 'socket_error', 'success', 'timeout', 'too_many_connections', 'tx_buffer_overflow', 'tx_error', 'unknown_close_error', 'unknown_open_error', 'unknown_send_error']
class CanDevice:
    @staticmethod
...
class CanDeviceArguments:
    def __init__(self, config: CanDeviceConfiguration, receiver: typing.Callable[[CanFrame], None]) -> None:
        ...
    @property
...
class CanReturnCode:
    ...
    Members:
      ...
      unknown_close_error
    """
    __members__: typing.ClassVar[dict[str, CanReturnCode]]  # value = {'success': <CanReturnCode.success: 0>, 'unknown_open_error': <CanReturnCode.unknown_open_error: 1>, 'socket_error': <CanReturnCode.socket_error: 2>, 'too_many_connections': <CanReturnCode.too_many_connections: 3>, 'timeout': <CanReturnCode.timeout: 4>, 'disconnected': <CanReturnCode.disconnected: 5>, 'internal_api_error': <CanReturnCode.internal_api_error: 6>, 'unknown_send_error': <CanReturnCode.unknown_send_error: 7>, 'not_ack': <CanReturnCode.not_ack: 8>, 'tx_error': <CanReturnCode.tx_error: 10>, 'rx_error': <CanReturnCode.rx_error: 9>, 'tx_buffer_overflow': <CanReturnCode.tx_buffer_overflow: 11>, 'lost_arbitration': <CanReturnCode.lost_arbitration: 12>, 'invalid_bitrate': <CanReturnCode.invalid_bitrate: 13>, 'unknown_close_error': <CanReturnCode.unknown_close_error: 14>}
    disconnected: typing.ClassVar[CanReturnCode]  # value = <CanReturnCode.disconnected: 5>
    internal_api_error: typing.ClassVar[CanReturnCode]  # value = <CanReturnCode.internal_api_error: 6>
    invalid_bitrate: typing.ClassVar[CanReturnCode]  # value = <CanReturnCode.invalid_bitrate: 13>
    lost_arbitration: typing.ClassVar[CanReturnCode]  # value = <CanReturnCode.lost_arbitration: 12>
    ...
    socket_error: typing.ClassVar[CanReturnCode]  # value = <CanReturnCode.socket_error: 2>
    ...
    too_many_connections: typing.ClassVar[CanReturnCode]  # value = <CanReturnCode.too_many_connections: 3>
    tx_buffer_overflow: typing.ClassVar[CanReturnCode]  # value = <CanReturnCode.tx_buffer_overflow: 11>
    tx_error: typing.ClassVar[CanReturnCode]  # value = <CanReturnCode.tx_error: 10>
    unknown_close_error: typing.ClassVar[CanReturnCode]  # value = <CanReturnCode.unknown_close_error: 14>
    unknown_open_error: typing.ClassVar[CanReturnCode]  # value = <CanReturnCode.unknown_open_error: 1>
    unknown_send_error: typing.ClassVar[CanReturnCode]  # value = <CanReturnCode.unknown_send_error: 7>
