...
\item 
virtual int \mbox{\hyperlink{classAnaCanScan_a64b086259bdd302b1d40cb9b7be49e5b}{create\+Bus}} (const std\+::string name, const std\+::string parameters)
\item 
...
\item 
virtual void \mbox{\hyperlink{classAnaCanScan_a4631538bddfbe61637ea5ed0071b780f}{stop\+Bus}} (void)
\end{DoxyCompactItemize}
...
\item 
void \mbox{\hyperlink{classAnaCanScan_ae5b4e8c387c5f92576d0b3869fece47a}{Can\+Reconnection\+Thread}} ()
\item 
bool \mbox{\hyperlink{classAnaCanScan_a6260e2ac6ce9c181ad5d64551ddeb60c}{send\+An\+Error\+Message}} (Ana\+Int32 status)
\item 
std\+::string \mbox{\hyperlink{classAnaCanScan_a8816262d658e19111e10b05cceb2e4f9}{ip\+Adress}} ()
\item 
...
\item 
int \mbox{\hyperlink{classAnaCanScan_a9a235b690fe0be49a3e55d487ca72a57}{configure\+Can\+Board}} (const std\+::string name, const std\+::string parameters)
\item 
...
\item 
const char $\ast$ \mbox{\hyperlink{classAnaCanScan_a25489463d6a0a1f2f122a0bfc55bb318}{error\+Code\+To\+String}} (long error)
\item 
...
\item 
static int \mbox{\hyperlink{classAnaCanScan_a6f8433af30b66333a940c4fbdbb64b5b}{reconnect\+All\+Ports}} (std\+::string ip)
\item 
...
\item 
static void \mbox{\hyperlink{classAnaCanScan_a49edbc1e0e48d5d487238bc76fa133b9}{set\+Ip\+Reconnect\+In\+Progress}} (std\+::string ip, bool flag)
\item 
static bool \mbox{\hyperlink{classAnaCanScan_ad07c0156fc64b9741b93c8087271697e}{is\+Ip\+Reconnect\+In\+Progress}} (std\+::string ip)
\end{DoxyCompactItemize}
...
\item 
std\+::string \mbox{\hyperlink{classAnaCanScan_a9de78cb4cdba4a4dca1910d752b4ff65}{m\+\_\+can\+I\+P\+Address}}
\item 
...
\item 
std\+::string \mbox{\hyperlink{classAnaCanScan_a86b2f6e716cbe52a850ec75c1736b7af}{m\+\_\+bus\+Name}}
\item 
std\+::string \mbox{\hyperlink{classAnaCanScan_a5558200a84f7754415c1b0625ee7f576}{m\+\_\+bus\+Parameters}}
\item 
...
\item 
bool \mbox{\hyperlink{classAnaCanScan_a9777d181ff5f28da363907ecb50ebc90}{m\+\_\+bus\+Stopped}}
\end{DoxyCompactItemize}
...
\item 
static std\+::map$<$ std\+::string, bool $>$ \mbox{\hyperlink{classAnaCanScan_a09cebd448f6a018081f94d2824ae391b}{m\+\_\+reconnect\+In\+Progress\+\_\+map}}
\end{DoxyCompactItemize}
\doxysubsection*{Additional Inherited Members}


\doxysubsection{Detailed Description}
one C\+AN port on an anagate bridge, an anagate bridge is an ip number. There are (physical) bridges with several ip numbers\+: we treat them as separated modules. 

Definition at line 74 of file Ana\+Can\+Scan.\+h.
...
Definition at line 55 of file Ana\+Can\+Scan.\+cpp.



References Can\+Module\+::\+Can\+Statistics\+::begin\+New\+Run(), Can\+Reconnection\+Thread(), Can\+Module\+::\+C\+Can\+Access\+::m\+\_\+failed\+Send\+Countdown, Can\+Module\+::\+C\+Can\+Access\+::m\+\_\+h\+Can\+Reconnection\+Thread, Can\+Module\+::\+C\+Can\+Access\+::m\+\_\+max\+Failed\+Send\+Count, m\+\_\+statistics, and Can\+Module\+::\+Can\+Statistics\+::set\+Time\+Since\+Opened().
...
Definition at line 98 of file Ana\+Can\+Scan.\+cpp.
...
Definition at line 358 of file Ana\+Can\+Scan.\+cpp.
...
Definition at line 991 of file Ana\+Can\+Scan.\+cpp.
...
Definition at line 156 of file Ana\+Can\+Scan.\+h.

\mbox{\Hypertarget{classAnaCanScan_ae5b4e8c387c5f92576d0b3869fece47a}\label{classAnaCanScan_ae5b4e8c387c5f92576d0b3869fece47a}} 
\index{AnaCanScan@{AnaCanScan}!CanReconnectionThread@{CanReconnectionThread}}
\index{CanReconnectionThread@{CanReconnectionThread}!AnaCanScan@{AnaCanScan}}
\doxysubsubsection{\texorpdfstring{CanReconnectionThread()}{CanReconnectionThread()}}
{\footnotesize\ttfamily void Ana\+Can\+Scan\+::\+Can\+Reconnection\+Thread (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
anagate (physical) modules can have more than one ethernet R\+J45. we treat each ip address as \char`\"{}one bridge\char`\"{} in this context
...
Definition at line 1038 of file Ana\+Can\+Scan.\+cpp.



References Can\+Module\+::all\+Buses\+On\+Bridge, Can\+Module\+::\+C\+Can\+Access\+::get\+Bus\+Name(), get\+Reconnect\+Action(), get\+Reconnect\+Condition(), ip\+Adress(), m\+\_\+can\+I\+P\+Address, Can\+Module\+::\+C\+Can\+Access\+::m\+\_\+failed\+Send\+Countdown, Can\+Module\+::\+C\+Can\+Access\+::m\+\_\+reconnect\+Action, Can\+Module\+::\+C\+Can\+Access\+::m\+\_\+reconnect\+Condition, M\+L\+O\+G\+A\+NA, Can\+Module\+::never, Can\+Module\+::\+C\+Can\+Access\+::reconnect\+Action\+String(), reconnect\+All\+Ports(), Can\+Module\+::\+C\+Can\+Access\+::reconnect\+Condition\+String(), reconnect\+This\+Port(), Can\+Module\+::\+C\+Can\+Access\+::reset\+Send\+Failed\+Countdown(), Can\+Module\+::\+C\+Can\+Access\+::reset\+Timeout\+On\+Reception(), Can\+Module\+::send\+Fail, show\+Ana\+Can\+Scan\+Object\+Map(), Can\+Module\+::single\+Bus, Can\+Module\+::timeout\+On\+Reception, and Can\+Module\+::\+C\+Can\+Access\+::wait\+For\+Reconnection\+Thread\+Trigger().



Referenced by Ana\+Can\+Scan().

Here is the call graph for this function\+:
% FIG 6
\mbox{\Hypertarget{classAnaCanScan_a9a235b690fe0be49a3e55d487ca72a57}\label{classAnaCanScan_a9a235b690fe0be49a3e55d487ca72a57}} 
...
{\footnotesize\ttfamily int Ana\+Can\+Scan\+::configure\+Can\+Board (\begin{DoxyParamCaption}\item[{const std\+::string}]{name,  }\item[{const std\+::string}]{parameters }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}

decode the name, parameter and return the port of the configured module i.\+e. name=\char`\"{}an\+:0\+:128.\+141.\+159.\+194\char`\"{} i.\+e. parameters= \char`\"{}p0 p1 p2 p3 p4 p5 p6\char`\"{} with i.\+e. \char`\"{}125000 0 1 0 0 0 6000\char`\"{} p0=baudrate p1= operation mode p2 = termination p3 = high speed flag p4 = time stamp p5 = sync mode p6 = timeout/ms 

Definition at line 278 of file Ana\+Can\+Scan.\+cpp.



References m\+\_\+baud\+Rate, m\+\_\+can\+I\+P\+Address, Can\+Module\+::\+C\+Can\+Access\+::m\+\_\+\+Can\+Parameters, m\+\_\+can\+Port\+Number, Can\+Module\+::\+Can\+Parameters\+::m\+\_\+i\+High\+Speed, Can\+Module\+::\+Can\+Parameters\+::m\+\_\+i\+Number\+Of\+Detected\+Parameters, Can\+Module\+::\+Can\+Parameters\+::m\+\_\+i\+Operation\+Mode, Can\+Module\+::\+Can\+Parameters\+::m\+\_\+i\+Sync\+Mode, Can\+Module\+::\+Can\+Parameters\+::m\+\_\+i\+Termination, Can\+Module\+::\+Can\+Parameters\+::m\+\_\+i\+Timeout, Can\+Module\+::\+Can\+Parameters\+::m\+\_\+i\+Time\+Stamp, Can\+Module\+::\+Can\+Parameters\+::m\+\_\+l\+Baud\+Rate, m\+\_\+timeout, M\+L\+O\+G\+A\+NA, open\+Can\+Port(), and Can\+Module\+::\+C\+Can\+Access\+::parse\+Name\+And\+Parameters().
...
Definition at line 786 of file Ana\+Can\+Scan.\+cpp.
...
Here is the call graph for this function\+:
% FIG 8
\mbox{\Hypertarget{classAnaCanScan_a64b086259bdd302b1d40cb9b7be49e5b}\label{classAnaCanScan_a64b086259bdd302b1d40cb9b7be49e5b}} 
...
{\footnotesize\ttfamily int Ana\+Can\+Scan\+::create\+Bus (\begin{DoxyParamCaption}\item[{const std\+::string}]{name,  }\item[{const std\+::string}]{parameters }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}
...
Definition at line 236 of file Ana\+Can\+Scan.\+cpp.



References configure\+Can\+Board(), Can\+Module\+::\+Log\+It\+Component\+Name, m\+\_\+bus\+Name, m\+\_\+bus\+Parameters, m\+\_\+bus\+Stopped, M\+L\+O\+G\+A\+NA, and st\+\_\+log\+It\+Handle\+Anagate.
...
Definition at line 376 of file Ana\+Can\+Scan.\+cpp.
...
Definition at line 837 of file Ana\+Can\+Scan.\+cpp.
...
\mbox{\Hypertarget{classAnaCanScan_a25489463d6a0a1f2f122a0bfc55bb318}\label{classAnaCanScan_a25489463d6a0a1f2f122a0bfc55bb318}} 
...
{\footnotesize\ttfamily const char$\ast$ Ana\+Can\+Scan\+::error\+Code\+To\+String (\begin{DoxyParamCaption}\item[{long}]{error }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [private]}}



Definition at line 162 of file Ana\+Can\+Scan.\+h.



Referenced by send\+An\+Error\+Message().
...
Definition at line 401 of file Ana\+Can\+Scan.\+cpp.
...
Definition at line 93 of file Ana\+Can\+Scan.\+h.
...
{\footnotesize\ttfamily uint32\+\_\+t Ana\+Can\+Scan\+::get\+Port\+Status (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}
...
Definition at line 90 of file Ana\+Can\+Scan.\+cpp.



References C\+A\+N\+M\+O\+D\+U\+L\+E\+\_\+\+S\+T\+A\+T\+U\+S\+\_\+\+B\+P\+\_\+\+A\+N\+A\+G\+A\+TE, and m\+\_\+\+Ucan\+Handle.
...
Referenced by Can\+Reconnection\+Thread(), and send\+Message().
...
Definition at line 1018 of file Ana\+Can\+Scan.\+cpp.
...
Definition at line 157 of file Ana\+Can\+Scan.\+h.



Referenced by add\+Can\+Handle\+Of\+Port\+Ip(), and delete\+Can\+Handle\+Of\+Port\+Ip().

\mbox{\Hypertarget{classAnaCanScan_a8816262d658e19111e10b05cceb2e4f9}\label{classAnaCanScan_a8816262d658e19111e10b05cceb2e4f9}} 
...
{\footnotesize\ttfamily std\+::string Ana\+Can\+Scan\+::ip\+Adress (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [private]}}



Definition at line 155 of file Ana\+Can\+Scan.\+h.



Referenced by Can\+Reconnection\+Thread().

\mbox{\Hypertarget{classAnaCanScan_ad07c0156fc64b9741b93c8087271697e}\label{classAnaCanScan_ad07c0156fc64b9741b93c8087271697e}} 
...
{\footnotesize\ttfamily bool Ana\+Can\+Scan\+::is\+Ip\+Reconnect\+In\+Progress (\begin{DoxyParamCaption}\item[{std\+::string}]{ip }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}
...
Definition at line 138 of file Ana\+Can\+Scan.\+cpp.
...
Definition at line 424 of file Ana\+Can\+Scan.\+cpp.
...
Definition at line 856 of file Ana\+Can\+Scan.\+cpp.
...
Here is the call graph for this function\+:
% FIG 13
\mbox{\Hypertarget{classAnaCanScan_a6f8433af30b66333a940c4fbdbb64b5b}\label{classAnaCanScan_a6f8433af30b66333a940c4fbdbb64b5b}} 
...
{\footnotesize\ttfamily Ana\+Int32 Ana\+Can\+Scan\+::reconnect\+All\+Ports (\begin{DoxyParamCaption}\item[{std\+::string}]{ip }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}
...
Definition at line 673 of file Ana\+Can\+Scan.\+cpp.
...
Definition at line 621 of file Ana\+Can\+Scan.\+cpp.
...
Here is the call graph for this function\+:
% FIG 15
\mbox{\Hypertarget{classAnaCanScan_a6260e2ac6ce9c181ad5d64551ddeb60c}\label{classAnaCanScan_a6260e2ac6ce9c181ad5d64551ddeb60c}} 
\index{AnaCanScan@{AnaCanScan}!sendAnErrorMessage@{sendAnErrorMessage}}
\index{sendAnErrorMessage@{sendAnErrorMessage}!AnaCanScan@{AnaCanScan}}
\doxysubsubsection{\texorpdfstring{sendAnErrorMessage()}{sendAnErrorMessage()}}
{\footnotesize\ttfamily bool Ana\+Can\+Scan\+::send\+An\+Error\+Message (\begin{DoxyParamCaption}\item[{Ana\+Int32}]{status }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}

if sending had a problem invoke the error handler with a message. Ultimately, this sends a boost\+::signal to a connected boost\+::slot in the client\textquotesingle{}s code. 

Definition at line 502 of file Ana\+Can\+Scan.\+cpp.
...
Definition at line 964 of file Ana\+Can\+Scan.\+cpp.
...
\end{DoxyReturn}
before sending the message we check if the reception timeout has not been overrun. Because this would entail some reconnection action, and in that case we skip the send on that bus. we invoke the thread only if the timeout has already occurred, and so we do not need to check the timeout in the thread anymore.
...
Definition at line 528 of file Ana\+Can\+Scan.\+cpp.



References Can\+Module\+::can\+Message2\+To\+String(), Can\+Module\+::\+C\+Can\+Access\+::decrease\+Send\+Failed\+Countdown(), Can\+Module\+::\+C\+Can\+Access\+::get\+Bus\+Name(), get\+Reconnect\+Condition(), Can\+Module\+::\+C\+Can\+Access\+::has\+Timeout\+On\+Reception(), m\+\_\+bus\+Stopped, m\+\_\+can\+Close\+Device, m\+\_\+can\+I\+P\+Address, m\+\_\+can\+Port\+Number, Can\+Module\+::\+C\+Can\+Access\+::m\+\_\+reconnect\+Condition, m\+\_\+statistics, m\+\_\+\+Ucan\+Handle, M\+L\+O\+G\+A\+NA, Can\+Module\+::\+Can\+Statistics\+::on\+Transmit(), Can\+Module\+::\+C\+Can\+Access\+::reconnect\+Condition\+String(), send\+An\+Error\+Message(), Can\+Module\+::\+Can\+Statistics\+::set\+Time\+Since\+Transmitted(), Can\+Module\+::timeout\+On\+Reception, and Can\+Module\+::\+C\+Can\+Access\+::trigger\+Reconnection\+Thread().
...
Definition at line 976 of file Ana\+Can\+Scan.\+cpp.



References m\+\_\+\+Ucan\+Handle, M\+L\+O\+G\+A\+NA, and send\+An\+Error\+Message().

Here is the call graph for this function\+:
% FIG 19
\mbox{\Hypertarget{classAnaCanScan_a49edbc1e0e48d5d487238bc76fa133b9}\label{classAnaCanScan_a49edbc1e0e48d5d487238bc76fa133b9}} 
...
{\footnotesize\ttfamily void Ana\+Can\+Scan\+::set\+Ip\+Reconnect\+In\+Progress (\begin{DoxyParamCaption}\item[{std\+::string}]{ip,  }\item[{bool}]{flag }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}



Definition at line 117 of file Ana\+Can\+Scan.\+cpp.
...
Definition at line 95 of file Ana\+Can\+Scan.\+h.
...
Definition at line 99 of file Ana\+Can\+Scan.\+h.
...
Definition at line 603 of file Ana\+Can\+Scan.\+cpp.
...
Referenced by Can\+Reconnection\+Thread(), reconnect\+All\+Ports(), and reconnect\+This\+Port().
...
Definition at line 192 of file Ana\+Can\+Scan.\+cpp.
...
{\footnotesize\ttfamily void Ana\+Can\+Scan\+::stop\+Bus (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}
...
Definition at line 104 of file Ana\+Can\+Scan.\+cpp.



References delete\+Can\+Handle\+Of\+Port\+Ip(), erase\+Reception\+Handler\+From\+Map(), m\+\_\+bus\+Name, m\+\_\+bus\+Stopped, m\+\_\+can\+I\+P\+Address, m\+\_\+can\+Port\+Number, m\+\_\+\+Ucan\+Handle, and M\+L\+O\+G\+A\+NA.
...
\mbox{\Hypertarget{classAnaCanScan_a86b2f6e716cbe52a850ec75c1736b7af}\label{classAnaCanScan_a86b2f6e716cbe52a850ec75c1736b7af}} 
...
{\footnotesize\ttfamily std\+::string Ana\+Can\+Scan\+::m\+\_\+bus\+Name\hspace{0.3cm}{\ttfamily [private]}}
...
\mbox{\Hypertarget{classAnaCanScan_a5558200a84f7754415c1b0625ee7f576}\label{classAnaCanScan_a5558200a84f7754415c1b0625ee7f576}} 
...
{\footnotesize\ttfamily std\+::string Ana\+Can\+Scan\+::m\+\_\+bus\+Parameters\hspace{0.3cm}{\ttfamily [private]}}
...
\mbox{\Hypertarget{classAnaCanScan_a9777d181ff5f28da363907ecb50ebc90}\label{classAnaCanScan_a9777d181ff5f28da363907ecb50ebc90}} 
\index{AnaCanScan@{AnaCanScan}!m\_busStopped@{m\_busStopped}}
\index{m\_busStopped@{m\_busStopped}!AnaCanScan@{AnaCanScan}}
\doxysubsubsection{\texorpdfstring{m\_busStopped}{m\_busStopped}}
{\footnotesize\ttfamily bool Ana\+Can\+Scan\+::m\+\_\+bus\+Stopped\hspace{0.3cm}{\ttfamily [private]}}
...
\mbox{\Hypertarget{classAnaCanScan_a9de78cb4cdba4a4dca1910d752b4ff65}\label{classAnaCanScan_a9de78cb4cdba4a4dca1910d752b4ff65}} 
...
{\footnotesize\ttfamily std\+::string Ana\+Can\+Scan\+::m\+\_\+can\+I\+P\+Address\hspace{0.3cm}{\ttfamily [private]}}



Definition at line 108 of file Ana\+Can\+Scan.\+h.



Referenced by Can\+Reconnection\+Thread(), configure\+Can\+Board(), connect\+Reception\+Handler(), open\+Can\+Port(), reconnect(), reconnect\+This\+Port(), send\+Message(), and stop\+Bus().
...
Definition at line 107 of file Ana\+Can\+Scan.\+h.
...
\mbox{\Hypertarget{classAnaCanScan_a09cebd448f6a018081f94d2824ae391b}\label{classAnaCanScan_a09cebd448f6a018081f94d2824ae391b}} 
...
{\footnotesize\ttfamily std\+::map$<$ std\+::string, bool $>$ Ana\+Can\+Scan\+::m\+\_\+reconnect\+In\+Progress\+\_\+map\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}



Definition at line 150 of file Ana\+Can\+Scan.\+h.
...
Referenced by configure\+Can\+Board(), open\+Can\+Port(), and reconnect().
...
Referenced by connect\+Reception\+Handler(), get\+Port\+Status(), open\+Can\+Port(), reconnect(), send\+Message(), send\+Remote\+Request(), and stop\+Bus().
