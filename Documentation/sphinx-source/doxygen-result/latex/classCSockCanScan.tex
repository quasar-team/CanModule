...
Definition at line 488 of file Sock\+Can\+Scan.\+cpp.
...
we get triggered all the time, essentially with reception timeouts, but also sometimes with a send fail. we need to manage the conditions since the triggering is identical, no parameters are transmitted, the predicate is just a boolean to keep it simple.

... or the reception timed out\+: we did not receive anything on the bus for a certain time (not\+: count). That is a somewhat dangerous condition but it can be extremely useful if you know what you do.
...
O\+P\+C\+U\+A-\/2607. Lets just stop filtering them out. This is only done here anyway, all other vendor implementations don\textquotesingle{}t care.
...
the reconnect behavior happens in an extra thread so that the send\+Message becomes non blocking. This is the reception of the message part, and strictly speaking we could do the reconnection due to reception message timeout also here. For cleanliness, lets use that extra reconnection thread nevertheless here.

that reconnection thread is always up and it depends on three private variables\+: the socket, the Reconnect\+Auto\+Condition and the Reconnect\+Action. It is done in a pretty stupid way so that is is fast, for all vendors\+: you just trigger it whenever and it checks itself what to do.

Definition at line 103 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 1037 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 494 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 89 of file Sock\+Can\+Scan.\+h.
...
Definition at line 963 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 84 of file Sock\+Can\+Scan.\+h.
...
Definition at line 79 of file Sock\+Can\+Scan.\+h.
...
Definition at line 73 of file Sock\+Can\+Scan.\+h.
...
Definition at line 1080 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 535 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 1046 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 691 of file Sock\+Can\+Scan.\+cpp.



References empty\+Can\+Frame(), m\+\_\+\+Can\+Scan\+Thread\+Run\+Enable\+Flag, m\+\_\+sock, and M\+L\+O\+G\+S\+O\+CK.
...
Definition at line 831 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 101 of file Sock\+Can\+Scan.\+h.
...
Definition at line 106 of file Sock\+Can\+Scan.\+h.
...
Definition at line 1057 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 633 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 1089 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 126 of file Sock\+Can\+Scan.\+h.
...
Referenced by Can\+Reconnection\+Thread(), clear\+Error\+Message(), create\+Bus(), open\+Can\+Port(), send\+Error\+Message(), send\+Message(), and send\+Remote\+Request().
