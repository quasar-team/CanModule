...
\begin{center}
\leavevmode
\includegraphics[width=217pt]{classCSockCanScan__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCSockCanScan__coll__graph}
\end{center}
\end{figure}
...
\item 
virtual int \mbox{\hyperlink{classCSockCanScan_a879da2908384a8f154120bdd0c60c5aa}{create\+Bus}} (const string name, string parameters)
\item 
...
\begin{DoxyCompactItemize}
\item 
static std\+::map$<$ string, string $>$ \mbox{\hyperlink{classCSockCanScan_a596ffa46b85d51c580757cab52baead9}{m\+\_\+bus\+Map}}
\end{DoxyCompactItemize}
\doxysubsection*{Private Member Functions}
\begin{DoxyCompactItemize}
\item 
bool \mbox{\hyperlink{classCSockCanScan_a114206337d501fc78a55d2e3d1f4a22b}{stop\+Bus}} ()
\item 
void \mbox{\hyperlink{classCSockCanScan_a623057580187ecb241adf143c64d711c}{update\+Initial\+Error}} ()
\item 
void \mbox{\hyperlink{classCSockCanScan_a512733f202345e5940460f84539c979a}{send\+Error\+Message}} (const char $\ast$)
\item 
void \mbox{\hyperlink{classCSockCanScan_a4b5f7591bfd27b8770bfb9ac9e406f66}{clear\+Error\+Message}} ()
\item 
int \mbox{\hyperlink{classCSockCanScan_a8bb8fcdb24b2b917258d027e6a468bae}{configure\+Can\+Board}} (const string name, const string parameters)
\item 
void \mbox{\hyperlink{classCSockCanScan_aaed83a57ee1b70fff48a1a5ca9655fe6}{update\+Bus\+Status}} ()
\item 
...
\item 
static void $\ast$ \mbox{\hyperlink{classCSockCanScan_a9ac2e2d3f63449865e22c69a60faf53d}{Can\+Scan\+Control\+Thread}} (void $\ast$)
\end{DoxyCompactItemize}
\doxysubsection*{Private Attributes}
\begin{DoxyCompactItemize}
\item 
volatile bool \mbox{\hyperlink{classCSockCanScan_a718ca5a81cc7741192b7d8762b338fdd}{m\+\_\+\+Can\+Scan\+Thread\+Run\+Enable\+Flag}}
\item 
int \mbox{\hyperlink{classCSockCanScan_a0020e3c0b07bf14fd3ef9c7d58660869}{m\+\_\+sock}}
\item 
...
\item 
pthread\+\_\+t \mbox{\hyperlink{classCSockCanScan_ac8e3a91f049a53fb88f6400b5caaf817}{m\+\_\+h\+Can\+Scan\+Thread}}
\item 
int \mbox{\hyperlink{classCSockCanScan_a91967ed6bf717bcfc5fae356725819bf}{m\+\_\+id\+Can\+Scan\+Thread}}
\item 
...
Definition at line 44 of file Sock\+Can\+Scan.\+h.
...
Definition at line 65 of file Sock\+Can\+Scan.\+cpp.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCSockCanScan_abfb8f5e3726f9675a63f48648afae178_cgraph}
\end{center}
\end{figure}
...
Definition at line 349 of file Sock\+Can\+Scan.\+cpp.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCSockCanScan_a243f91e993fcc96ddd5308c1425a130c_cgraph}
\end{center}
\end{figure}


\doxysubsection{Member Function Documentation}
\mbox{\Hypertarget{classCSockCanScan_a9ac2e2d3f63449865e22c69a60faf53d}\label{classCSockCanScan_a9ac2e2d3f63449865e22c69a60faf53d}} 
...
{\footnotesize\ttfamily void $\ast$ C\+Sock\+Can\+Scan\+::\+Can\+Scan\+Control\+Thread (\begin{DoxyParamCaption}\item[{void $\ast$}]{p\+\_\+void\+Sock\+Can\+Scan }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}

The main control thread function for the C\+AN update scan manager.
...
lets check the timeout\+On\+Reception reconnect condition. If it is true, all we can do is to close/open the socket again since the underlying hardware is hidden by socketcan abstraction. Like his we do not have to pollute the \char`\"{}send\+Message\char`\"{} like for anagate, and that is cleaner.

Definition at line 100 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 844 of file Sock\+Can\+Scan.\+cpp.



References Can\+Module\+::\+C\+Can\+Access\+::can\+Message\+Error, m\+\_\+sock, and M\+L\+O\+G\+S\+O\+CK.



Referenced by update\+Initial\+Error().

\mbox{\Hypertarget{classCSockCanScan_a8bb8fcdb24b2b917258d027e6a468bae}\label{classCSockCanScan_a8bb8fcdb24b2b917258d027e6a468bae}} 
...
{\footnotesize\ttfamily int C\+Sock\+Can\+Scan\+::configure\+Can\+Board (\begin{DoxyParamCaption}\item[{const string}]{name,  }\item[{const string}]{parameters }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
Definition at line 354 of file Sock\+Can\+Scan.\+cpp.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCSockCanScan_a8bb8fcdb24b2b917258d027e6a468bae_cgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{classCSockCanScan_a879da2908384a8f154120bdd0c60c5aa}\label{classCSockCanScan_a879da2908384a8f154120bdd0c60c5aa}} 
...
{\footnotesize\ttfamily int C\+Sock\+Can\+Scan\+::create\+Bus (\begin{DoxyParamCaption}\item[{const string}]{name,  }\item[{string}]{parameters }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}
...
\end{DoxyReturn}
dont create a main thread for the same bus twice\+: if it exists already, just configure the board again this protects agains having multiple threads if a given port ports is opened several times\+: protects against erro/unusual runtime. If the connection is closed, it\textquotesingle{}s main thread is stopped and joined, and the port is erased from the connection map. when the same port is opened again later on, a (new) main thread is created, and the connection is again added to the map. 

Implements \mbox{\hyperlink{classCanModule_1_1CCanAccess_a0eeee5c3d48f1102012d1483cbe6e64b}{Can\+Module\+::\+C\+Can\+Access}}.



Definition at line 725 of file Sock\+Can\+Scan.\+cpp.



References Can\+Scan\+Control\+Thread(), configure\+Can\+Board(), Can\+Module\+::\+Log\+It\+Component\+Name, m\+\_\+bus\+Map, m\+\_\+bus\+Name, m\+\_\+\+Can\+Scan\+Thread\+Run\+Enable\+Flag, m\+\_\+h\+Can\+Scan\+Thread, m\+\_\+id\+Can\+Scan\+Thread, m\+\_\+log\+It\+Handle\+Sock, m\+\_\+sock, M\+L\+O\+G\+S\+O\+CK, and sock\+Reconnect\+Mutex.

Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCSockCanScan_a879da2908384a8f154120bdd0c60c5aa_cgraph}
\end{center}
\end{figure}
...
Definition at line 87 of file Sock\+Can\+Scan.\+h.
...
{\footnotesize\ttfamily std\+::string C\+Sock\+Can\+Scan\+::error\+Frame\+To\+String (\begin{DoxyParamCaption}\item[{const struct can\+\_\+frame \&}]{f }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}, {\ttfamily [private]}}

Transforms an error frame into an error message (string format) 

Definition at line 770 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 82 of file Sock\+Can\+Scan.\+h.
...
Definition at line 77 of file Sock\+Can\+Scan.\+h.
...
Definition at line 109 of file Sock\+Can\+Scan.\+h.
...
Definition at line 108 of file Sock\+Can\+Scan.\+h.
...
Definition at line 888 of file Sock\+Can\+Scan.\+cpp.



References Can\+Module\+::\+Can\+Statistics\+::begin\+New\+Run(), Can\+Module\+::\+Can\+Statistics\+::compute\+Derived(), Can\+Module\+::\+Can\+Statistics\+::encode\+Can\+Module\+Status(), Can\+Module\+::\+C\+Can\+Access\+::m\+\_\+\+Can\+Parameters, Can\+Module\+::\+Can\+Parameters\+::m\+\_\+l\+Baud\+Rate, and m\+\_\+statistics.

Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCSockCanScan_a38110f02c2d12fa9b620ba5ff438a960_cgraph}
\end{center}
\end{figure}
...
Definition at line 395 of file Sock\+Can\+Scan.\+cpp.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCSockCanScan_a203a51239f8efc013d4b9df36f271317_cgraph}
\end{center}
\end{figure}
...
\mbox{\Hypertarget{classCSockCanScan_a512733f202345e5940460f84539c979a}\label{classCSockCanScan_a512733f202345e5940460f84539c979a}} 
\index{CSockCanScan@{CSockCanScan}!sendErrorMessage@{sendErrorMessage}}
\index{sendErrorMessage@{sendErrorMessage}!CSockCanScan@{CSockCanScan}}
\doxysubsubsection{\texorpdfstring{sendErrorMessage()}{sendErrorMessage()}}
{\footnotesize\ttfamily void C\+Sock\+Can\+Scan\+::send\+Error\+Message (\begin{DoxyParamCaption}\item[{const char $\ast$}]{mess }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}



Definition at line 853 of file Sock\+Can\+Scan.\+cpp.
...
Definition at line 661 of file Sock\+Can\+Scan.\+cpp.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCSockCanScan_a4999204ff7166ee992a89b30a118af06_cgraph}
\end{center}
\end{figure}
...
Definition at line 99 of file Sock\+Can\+Scan.\+h.
...
Definition at line 104 of file Sock\+Can\+Scan.\+h.
...
Definition at line 103 of file Sock\+Can\+Scan.\+h.

\mbox{\Hypertarget{classCSockCanScan_a114206337d501fc78a55d2e3d1f4a22b}\label{classCSockCanScan_a114206337d501fc78a55d2e3d1f4a22b}} 
...
{\footnotesize\ttfamily bool C\+Sock\+Can\+Scan\+::stop\+Bus (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
Definition at line 864 of file Sock\+Can\+Scan.\+cpp.



References m\+\_\+bus\+Map, m\+\_\+bus\+Name, m\+\_\+\+Can\+Scan\+Thread\+Run\+Enable\+Flag, m\+\_\+h\+Can\+Scan\+Thread, m\+\_\+id\+Can\+Scan\+Thread, M\+L\+O\+G\+S\+O\+CK, and sock\+Reconnect\+Mutex.



Referenced by $\sim$\+C\+Sock\+Can\+Scan().

\mbox{\Hypertarget{classCSockCanScan_aaed83a57ee1b70fff48a1a5ca9655fe6}\label{classCSockCanScan_aaed83a57ee1b70fff48a1a5ca9655fe6}} 
\index{CSockCanScan@{CSockCanScan}!updateBusStatus@{updateBusStatus}}
\index{updateBusStatus@{updateBusStatus}!CSockCanScan@{CSockCanScan}}
\doxysubsubsection{\texorpdfstring{updateBusStatus()}{updateBusStatus()}}
{\footnotesize\ttfamily void C\+Sock\+Can\+Scan\+::update\+Bus\+Status (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}

update the C\+AN bus status I\+F\+LA from socketcan and make up a \mbox{\hyperlink{namespaceCanModule}{Can\+Module}} status bitpattern out from this. Each vendor has to implement this with the same bit meanings.

Errors are a subset of status.

std\+::string \mbox{\hyperlink{classCSockCanScan_a177453d85f24c6b12b84468ac812cf5c}{C\+Sock\+Can\+Scan\+::error\+Frame\+To\+String(const struct can\+\_\+frame \&can\+Frame)}} fabricates a string, we need a bitpattern
...
Definition at line 491 of file Sock\+Can\+Scan.\+cpp.



References m\+\_\+channel\+Name, m\+\_\+statistics, and Can\+Module\+::\+Can\+Statistics\+::set\+Port\+Status().

Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCSockCanScan_aaed83a57ee1b70fff48a1a5ca9655fe6_cgraph}
\end{center}
\end{figure}
...
Definition at line 897 of file Sock\+Can\+Scan.\+cpp.



References Can\+Module\+::\+C\+Can\+Access\+::can\+Message\+Error, clear\+Error\+Message(), and m\+\_\+error\+Code.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classCSockCanScan_a623057580187ecb241adf143c64d711c_cgraph}
\end{center}
\end{figure}


\doxysubsection{Member Data Documentation}
\mbox{\Hypertarget{classCSockCanScan_a596ffa46b85d51c580757cab52baead9}\label{classCSockCanScan_a596ffa46b85d51c580757cab52baead9}} 
...
{\footnotesize\ttfamily std\+::map$<$ string, string $>$ C\+Sock\+Can\+Scan\+::m\+\_\+bus\+Map\hspace{0.3cm}{\ttfamily [static]}}
...
Definition at line 96 of file Sock\+Can\+Scan.\+h.
...
\mbox{\Hypertarget{classCSockCanScan_a718ca5a81cc7741192b7d8762b338fdd}\label{classCSockCanScan_a718ca5a81cc7741192b7d8762b338fdd}} 
...
{\footnotesize\ttfamily volatile bool C\+Sock\+Can\+Scan\+::m\+\_\+\+Can\+Scan\+Thread\+Run\+Enable\+Flag\hspace{0.3cm}{\ttfamily [private]}}
...
Referenced by configure\+Can\+Board(), open\+Can\+Port(), and update\+Bus\+Status().
...
\mbox{\Hypertarget{classCSockCanScan_ac8e3a91f049a53fb88f6400b5caaf817}\label{classCSockCanScan_ac8e3a91f049a53fb88f6400b5caaf817}} 
...
{\footnotesize\ttfamily pthread\+\_\+t C\+Sock\+Can\+Scan\+::m\+\_\+h\+Can\+Scan\+Thread\hspace{0.3cm}{\ttfamily [private]}}



Definition at line 116 of file Sock\+Can\+Scan.\+h.



Referenced by create\+Bus(), and stop\+Bus().

\mbox{\Hypertarget{classCSockCanScan_a91967ed6bf717bcfc5fae356725819bf}\label{classCSockCanScan_a91967ed6bf717bcfc5fae356725819bf}} 
\index{CSockCanScan@{CSockCanScan}!m\_idCanScanThread@{m\_idCanScanThread}}
\index{m\_idCanScanThread@{m\_idCanScanThread}!CSockCanScan@{CSockCanScan}}
\doxysubsubsection{\texorpdfstring{m\_idCanScanThread}{m\_idCanScanThread}}
{\footnotesize\ttfamily int C\+Sock\+Can\+Scan\+::m\+\_\+id\+Can\+Scan\+Thread\hspace{0.3cm}{\ttfamily [private]}}



Definition at line 117 of file Sock\+Can\+Scan.\+h.
...
Definition at line 122 of file Sock\+Can\+Scan.\+h.



Referenced by configure\+Can\+Board(), and create\+Bus().

\mbox{\Hypertarget{classCSockCanScan_a0020e3c0b07bf14fd3ef9c7d58660869}\label{classCSockCanScan_a0020e3c0b07bf14fd3ef9c7d58660869}} 
...
{\footnotesize\ttfamily int C\+Sock\+Can\+Scan\+::m\+\_\+sock\hspace{0.3cm}{\ttfamily [private]}}
...
Referenced by clear\+Error\+Message(), create\+Bus(), open\+Can\+Port(), send\+Error\+Message(), send\+Message(), and send\+Remote\+Request().
...
Definition at line 115 of file Sock\+Can\+Scan.\+h.



Referenced by C\+Sock\+Can\+Scan(), get\+Statistics(), open\+Can\+Port(), send\+Remote\+Request(), and update\+Bus\+Status().
